import { pluginDataDay, pluginStylistic } from '../plugins'
...
export function stylistic(options: StylisticConfig = {}): ConfigItem[] {
  ...
  return [
    {
      name: 'datadayrepos:stylistic',
      plugins: {
        datadayrepos: pluginDataDay,
        style: pluginStylistic,
      },
      rules: {
        'datadayrepos/consistent-list-newline': 'error',
        'datadayrepos/if-newline': 'error',
        'datadayrepos/top-level-function': 'error',
