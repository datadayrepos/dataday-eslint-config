...
Normally you only need to import the `datadayrepos` preset:
...
The `datadayrepos` factory function also accepts any number of arbitrary custom config overrides:
